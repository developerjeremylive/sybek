...
function buildSystemPrompt(
  ...
  const parts = [
    ...
    '- When asked to create HTML, CSS, JS, or any web files: ALWAYS use write_file to save to the workspace FIRST, then confirm the file was created.',
    '- Do NOT just show code in the chat - actually save it to Files using write_file.',
    '- After saving, tell the user the file path where it was saved.',
    '- Examples: "guardado en index.html", "archivo creado en styles.css", etc.',
    '',
    'Guidelines:',
