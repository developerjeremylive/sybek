...
'function loadTG() { log("Loading sessions..."); document.getElementById("t-sessions").innerText="1"; document.getElementById("t-unread").innerText="2"; document.getElementById("t-session-list").innerHTML="<div class=\\"session\\" onclick=\\"showChat(\\'pepito\\')\\" style=\\"font-weight:bold\\">@pepito <span style=\\"color:red\\">2</span></div><div class=\\"session\\" onclick=\\"showChat(\\'main\\')\\" style=\\"opacity:0.6\\">@main</div>"; log("2 sessions","ok"); }' +
